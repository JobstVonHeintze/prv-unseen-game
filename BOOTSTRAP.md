...
- **Domain vocabulary** is fixed by the bible. Use its words exactly: *phase*,
  ...
  *the Céleste meter*, *visibility*, *condition*, *incident*. Do not invent synonyms such as "karma",
...
| Condition | Felt bodily or material state with named levels. Player sees prose only. | `docs/decisions/2026-09-20-conditions-not-resources.md` |
| Incident | Action-triggered lock. Discrete pressure, not a clock. One or more valid exits. | `docs/decisions/2026-09-20-conditions-not-resources.md` |
